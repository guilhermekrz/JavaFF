...
// TODO: check other methods (in all Preferences)
public class Always implements GroundFact, UngroundFact {

	private Fact fact;

	public Always(Fact fact) {
		this.fact = fact;
	}
	...
	public String toStringTyped() {
		return "always (" + fact.toStringTyped() + ")";
	}
