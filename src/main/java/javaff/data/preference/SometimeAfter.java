...
public class SometimeAfter implements GroundFact, UngroundFact {

	private Fact fact1, fact2;

	public SometimeAfter(Fact fact1, Fact fact2) {
		this.fact1 = fact1;
		this.fact2 = fact2;
	}
	@Override
	...
	public String toStringTyped() {
		return "sometime-after (" + fact1.toStringTyped() + ") (" + fact2.toStringTyped() + ")";
	}

	@Override
	public String toString() {
		return "sometime-after (" + fact1 + ") (" + fact2 + ")";
	}
