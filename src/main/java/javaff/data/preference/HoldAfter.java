...
public class HoldAfter implements GroundFact, UngroundFact {

	private int num;
	private Fact fact;

	public HoldAfter(int num, Fact fact) {
		this.num = num;
		this.fact = fact;
	}
	...
	public String toStringTyped() {
		return "hold-during " + num + " (" + fact.toStringTyped() + ")";
	}

	@Override
	public String toString() {
		return "hold-during " + num + " (" + fact + "";
	}
