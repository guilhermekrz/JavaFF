...
public class SometimeBefore implements GroundFact, UngroundFact {

	private Fact fact1, fact2;

	public SometimeBefore(Fact fact1, Fact fact2) {
		this.fact1 = fact1;
		this.fact2 = fact2;
	}
	...
	public String toStringTyped() {
		return "sometime-before (" + fact1.toStringTyped() + ") (" + fact2.toStringTyped() + ")";
	}

	@Override
	public String toString() {
		return "sometime-before (" + fact1 + ") (" + fact2 + ")";
	}
