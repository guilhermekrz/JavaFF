...
//	}
	...
	public void execute(Action a){
		...
		for(Fact not: a.getDeletePropositions())
			this.addFact(not);
	}
...
//	}
	...
	public boolean isTrue(Set<Fact> facts){
		if(facts == null) 
			return false;
	...
	public void calculateRP()
	{
		if (!RPCalculated)
		{
			...
			if (this.RelaxedPlan != null)
			{
				...
				this.HValue = new BigDecimal("100000");
	...
	public String toString()
	{
		...
		int size = 0;
		for (Object o : this.getFacts()){
			size++;
			strBuf.append(o + (size != this.getFacts().size() ? ", " : ""));
		}
